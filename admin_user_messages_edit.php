...
if(isset($_GET['edit_id'])){
 ...
 $sql = "SELECT * FROM contacts WHERE id =" .$_GET['edit_id'];
...
if(isset($_POST['btn-update'])){
 ...
 $update = "UPDATE contacts SET name='$name', email='$email', phone='$phone', message='$message' WHERE id=". $_GET['edit_id'];
                        ...
                        <form method="post">
                         <div class="form-group row">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-8">
                                 <input type="text" name="name" aria-label="text" class="form-control" value="<?php echo $row['name']; ?>"> 
                                </div>
                              </div>                              
                              <div class="form-group row">
                              ...
                              <div class="form-group row">
                                <label for="email" class="col-4 col-form-label"><b>Message:</b></label> 
                                <div class="col-8">
                                   <textarea class="form-control" name="message" value="<?php echo $row['message']; ?>"  aria-label="With textarea"></textarea>
                             ...
                             <form action="admin_edit.php" >
                               ...
                               <a href="admin_user_messages_edit.php" class="btn btn-success" role="button" aria-pressed="true" name="btn-update">Cancel</a>
                              </form>
